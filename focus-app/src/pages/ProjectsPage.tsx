      ...
      <div className="surface mt-5 rounded-xl p-3">
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            title={t(
              isCompleted
                ? 'projectsPage.card.reopenShort'
                : 'projectsPage.card.completeShort',
            )}
            className="flex items-center gap-1.5 text-xs font-medium text-accent-subtle transition hover:text-accent-green disabled:opacity-40"
          >
            {isToggling ? (
              <LoaderCircle
                size={15}
